...
namespace Drupal\Tests\marvin_phpunit_incubator\Helper;
...
class ComposerScripts {
  ...
  protected function prepareProjectComposerJson() {
    $content = [
      'name' => 'drupal/marvin-phpunit-incubator-tests-project_01',
      'description' => 'drupal/marvin-phpunit-incubator-tests-project_01',
      "license" => "proprietary",
      'type' => 'drupal-project',
      'extra' => [
        'installer-types' => [
...
TEXT;
  ...
  protected function getProjectSelfFilesToSymlink(): array {
    ...
    $filesToSymLink = $extra['marvin_phpunit_incubator']['fixtures']['filesToSymlink'] ?? [];
